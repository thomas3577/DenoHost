...
Write-Host "  DENOHOST_METADATA_SIGNING_PUBLIC_KEY_PEM  <- content of public pem file"
Write-Host ""
Write-Host "Next step: update BuiltInMetadataSigningPublicKeyPem in DenoHost.Core/Helper.cs with the new public key."
