...
/// <summary>Options for <c>deno run</c>. Run a JavaScript or TypeScript program, or a task</summary>
public sealed class RunOptions
{
  ...
  internal string[] ToArgs()
  {
    ...
    if (Hmr is not null) { if (Hmr.Length == 0) args.Add("--hmr"); else { args.Add("--hmr"); args.Add(string.Join(",", Hmr)); } }
